      ...
      >
        ...
        <SwiperSlide style={{ display: "flex", justifyContent: "center" }}>
          <div>
            <h2>JavaScript</h2>
            <p>
              Master the art of JavaScript and take your web development skills
              to the next level
            </p>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide style={{ display: "flex", justifyContent: "center" }}>
          <div>
            <h2>Node.js</h2>
            <p>
              Learn how to build fast and scalable server-side applications with
              Node.js
            </p>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide style={{ display: "flex", justifyContent: "center" }}>
          <div>
            <h2>Security</h2>
            <p>
              Learn how to secure your web applications and protect user data
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide style={{ display: "flex", justifyContent: "center" }}>
